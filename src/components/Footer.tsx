        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center mb-4">
              <img src="/logo_white.png" alt="CFO Edge 360" className="h-12" />
            </div>
          ...
          {/* Our Policy */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-white">Our Policy</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/privacy-policy" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/cookie-policy" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  Cookie Policy
                </Link>
              </li>
              <li>
                <Link to="/cancellation-refund-policy" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  Cancellation & Refund Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-conditions" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  Terms & Conditions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="mailto:hello@cfoedge360.com" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  hello@cfoedge360.com
                </a>
              </div>
              <div className="flex items-center">
                <Phone className="h-4 w-4 mr-3 text-gray-400" />
                <a href="tel:+15551234567" className="text-gray-400 hover:text-amber-400 transition-colors duration-200">
                  +1 (555) 123-4567
                </a>
              </div>

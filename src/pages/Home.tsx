      ...
      <section className="px-4 py-12 sm:py-16 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 font-serif mb-3 sm:mb-4">
            ...
            {services.map((service, index) => {
              ...
              return (
                <Link
                  key={index}
                  to={service.link}
                  className="group relative bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-amber-200 transform hover:-translate-y-1"
                >
                  ...
                  <h3 className="mb-2 sm:mb-3 text-base sm:text-lg font-semibold text-gray-900 leading-tight">
                    {service.title}
                  </h3>
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mb-3 sm:mb-4">
                    {service.description}
                  </p>
                  <div className="flex items-center text-amber-600 text-xs sm:text-sm font-medium group-hover:text-amber-700">
                    Learn more
